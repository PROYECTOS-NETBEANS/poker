 ...
 */
public class lienzo2 extends JPanel implements MouseMotionListener, MouseListener, Observer{
    ...
    public lienzo2(PokerClient cliente){
        super(true);
    ...
    public void mouseClicked(MouseEvent e) {
        ...
        if(k > 0){            
            ...
            System.out.println("inicio de lista de jugadores");
            if(jugadores != null){
