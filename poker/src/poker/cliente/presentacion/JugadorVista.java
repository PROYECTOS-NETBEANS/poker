...
public class JugadorVista extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel5.setText(".::DATOS DE JUGADOR::.");

        avatar.setBackground(new java.awt.Color(153, 255, 0));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(JugadorVista.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new JugadorVista().setVisible(true);
            }
        });
    }
